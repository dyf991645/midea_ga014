...
# 工作模式
MODE_HVAC = {0: HVACMode.OFF, 1: HVACMode.FAN_ONLY, 2: HVACMode.COOL, 3: HVACMode.HEAT, 4: HVACMode.AUTO,
             5: HVACMode.DRY}

# 风力模式
MODE_FAN = {0: 'off', 1: 'low', 2: 'higher low', 3: 'middle', 4: 'really middle', 5: 'medium', 6: 'lower high',
            7: 'high', 8: 'auto'}
